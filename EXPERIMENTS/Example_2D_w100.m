function config = Example_2D_w100()
%% ========================= OUTPUT FOLDER ================================
...
meshxt.Prot_mesh = [0 300 300; 0 300 300]; % [min, max, nº of points] per gene
meshxt.Time_mesh = [0 5 1000];             % [t0, t_end, number of points]
meshxt.w = 100;                            % control window size
